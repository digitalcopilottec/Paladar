...
const messages = {
  ...
  "Fechar menu": { en: "Close menu", es: "Cerrar menú", "pt-PT": "Fechar menu" },
  Fechar: { en: "Close", es: "Cerrar", "pt-PT": "Fechar" },
  Passageira: { en: "Passenger", es: "Pasajera", "pt-PT": "Passageira" },
  "Motorista parceiro": { en: "Partner driver", es: "Conductor socio", "pt-PT": "Motorista parceiro" },
  Inicio: { en: "Home", es: "Inicio", "pt-PT": "Início" },
  "Carteira e cashback": { en: "Wallet and cashback", es: "Billetera y cashback", "pt-PT": "Carteira e cashback" },
  "Perfil e dados": { en: "Profile and data", es: "Perfil y datos", "pt-PT": "Perfil e dados" },
  "Dados do passageiro": { en: "Passenger data", es: "Datos del pasajero", "pt-PT": "Dados do passageiro" },
  "Dados do motorista": { en: "Driver data", es: "Datos del conductor", "pt-PT": "Dados do motorista" },
  "Perfil do passageiro aberto": { en: "Passenger profile open", es: "Perfil del pasajero abierto", "pt-PT": "Perfil do passageiro aberto" },
  "Perfil do motorista aberto": { en: "Driver profile open", es: "Perfil del conductor abierto", "pt-PT": "Perfil do motorista aberto" },
  "Foto do perfil": { en: "Profile photo", es: "Foto de perfil", "pt-PT": "Foto do perfil" },
  "Anexar foto": { en: "Attach photo", es: "Adjuntar foto", "pt-PT": "Anexar foto" },
  "Foto do passageiro": { en: "Passenger photo", es: "Foto del pasajero", "pt-PT": "Foto do passageiro" },
  "Foto do motorista": { en: "Driver photo", es: "Foto del conductor", "pt-PT": "Foto do motorista" },
  "Anexe uma foto clara para facilitar a identificacao no embarque.": {
    en: "Attach a clear photo to make pickup identification easier.",
    es: "Adjunta una foto clara para facilitar la identificación en el embarque.",
    "pt-PT": "Anexe uma foto clara para facilitar a identificação no embarque.",
  },
  "Esta foto aparece para o passageiro antes do embarque.": {
    en: "This photo appears to the passenger before pickup.",
    es: "Esta foto aparece al pasajero antes del embarque.",
    "pt-PT": "Esta foto aparece para o passageiro antes do embarque.",
  },
  "Atualize foto, dados pessoais, veiculo, moto e chave PIX usados nas chamadas.": {
    en: "Update the photo, personal data, vehicle, motorcycle and PIX key used in requests.",
    es: "Actualiza la foto, datos personales, vehículo, moto y clave PIX usados en solicitudes.",
    "pt-PT": "Atualize foto, dados pessoais, veículo, moto e chave PIX usados nas chamadas.",
  },
  Celular: { en: "Phone", es: "Celular", "pt-PT": "Telemóvel" },
  "E-mail": { en: "Email", es: "Email", "pt-PT": "E-mail" },
  "Salvar dados": { en: "Save data", es: "Guardar datos", "pt-PT": "Guardar dados" },
  "Chave PIX": { en: "PIX key", es: "Clave PIX", "pt-PT": "Chave PIX" },
  "Suporte e seguranca": { en: "Support and safety", es: "Soporte y seguridad", "pt-PT": "Suporte e segurança" },
  "Pagina inicial": { en: "Home page", es: "Página inicial", "pt-PT": "Página inicial" },
  Sair: { en: "Sign out", es: "Salir", "pt-PT": "Sair" },
  Painel: { en: "Dashboard", es: "Panel", "pt-PT": "Painel" },
  "Ficar online/offline": { en: "Go online/offline", es: "Conectarse/desconectarse", "pt-PT": "Ficar online/offline" },
  "Conta e documentos": { en: "Account and documents", es: "Cuenta y documentos", "pt-PT": "Conta e documentos" },
  "Suporte Driver": { en: "Driver support", es: "Soporte Driver", "pt-PT": "Suporte Driver" },
  "Carteira Ride7 aberta": { en: "Ride7 wallet open", es: "Billetera Ride7 abierta", "pt-PT": "Carteira Ride7 aberta" },
  "Seu saldo Ride7": { en: "Your Ride7 balance", es: "Tu saldo Ride7", "pt-PT": "O seu saldo Ride7" },
  "Cashback disponivel": { en: "Available cashback", es: "Cashback disponible", "pt-PT": "Cashback disponível" },
  "Pontos Ride7": { en: "Ride7 points", es: "Puntos Ride7", "pt-PT": "Pontos Ride7" },
  "Voltar para corridas": { en: "Back to rides", es: "Volver a viajes", "pt-PT": "Voltar para viagens" },
  "Ajuda Ride7": { en: "Ride7 help", es: "Ayuda Ride7", "pt-PT": "Ajuda Ride7" },
  "Suporte e seguranca disponiveis": { en: "Support and safety available", es: "Soporte y seguridad disponibles", "pt-PT": "Suporte e segurança disponíveis" },
  "Acione emergencia durante uma corrida ou entrega.": {
    en: "Trigger emergency support during a ride or delivery.",
    es: "Activa emergencia durante un viaje o entrega.",
    "pt-PT": "Acione emergência durante uma viagem ou entrega.",
  },
  "Compartilhar viagem": { en: "Share trip", es: "Compartir viaje", "pt-PT": "Partilhar viagem" },
  "Envie a rota em tempo real para familiares.": {
    en: "Send the real-time route to family.",
    es: "Envía la ruta en tiempo real a familiares.",
    "pt-PT": "Envie a rota em tempo real para familiares.",
  },
  "WhatsApp Ride7": { en: "Ride7 WhatsApp", es: "WhatsApp Ride7", "pt-PT": "WhatsApp Ride7" },
  "Canal preparado para atendimento regional.": {
    en: "Channel prepared for regional support.",
    es: "Canal preparado para atención regional.",
    "pt-PT": "Canal preparado para atendimento regional.",
  },
  "Voltar para o app": { en: "Back to app", es: "Volver a la app", "pt-PT": "Voltar para a app" },
  "Ajuda Ride7 Driver": { en: "Ride7 Driver help", es: "Ayuda Ride7 Driver", "pt-PT": "Ajuda Ride7 Driver" },
  "Suporte para operar com seguranca": {
    en: "Support to operate safely",
    es: "Soporte para operar con seguridad",
    "pt-PT": "Suporte para operar com segurança",
  },
  "Use esta aba para acessar ajuda em corrida, repasses, documentos e atendimento regional.": {
    en: "Use this tab to access help with rides, payouts, documents and regional support.",
    es: "Usa esta pestaña para ayuda con viajes, repartos, documentos y soporte regional.",
    "pt-PT": "Use esta aba para ajuda em viagens, repasses, documentos e atendimento regional.",
  },
  "Corrida em andamento": { en: "Ride in progress", es: "Viaje en curso", "pt-PT": "Viagem em andamento" },
  "Suporte acompanha rota, passageiro, valor e status da chamada.": {
    en: "Support follows route, passenger, fare and request status.",
    es: "Soporte acompaña ruta, pasajero, valor y estado de la solicitud.",
    "pt-PT": "O suporte acompanha rota, passageiro, valor e estado da chamada.",
  },
  "Repasses e comissoes": { en: "Payouts and commissions", es: "Repartos y comisiones", "pt-PT": "Repasses e comissões" },
  "Confira a aba Monetizacao antes de aceitar chamadas.": {
    en: "Check the Monetization tab before accepting requests.",
    es: "Revisa la pestaña Monetización antes de aceptar solicitudes.",
    "pt-PT": "Confira a aba Monetização antes de aceitar chamadas.",
  },
  Documentos: { en: "Documents", es: "Documentos", "pt-PT": "Documentos" },
  "Atualize CNH, veiculo, moto, selfie e chave PIX.": {
    en: "Update license, vehicle, motorcycle, selfie and PIX key.",
    es: "Actualiza licencia, vehículo, moto, selfie y clave PIX.",
    "pt-PT": "Atualize CNH, veículo, moto, selfie e chave PIX.",
  },
